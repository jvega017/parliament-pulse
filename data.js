...
const SIGNALS = [
  {
    ...
    provenance: [
      { ts: "08:14:02", by: "parser", event: "Fetched item from Senate New Inquiries RSS (200 OK \xB7 2.3kb)" },
      { ts: "08:14:03", by: "parser", event: "Matched <item> schema v3 \xB7 GUID: aph-inq-2026-0412" },
      ...
      { ts: "08:14:05", by: "scoring", event: "Attention = 0.86 \u2192 HIGH (5-factor primary mean: authority 0.95 + portfolio 0.90 + novelty 0.90 + scrutiny 0.85 + ops 0.70) \xF7 5 = 0.86. Auxiliary signals: momentum 0.40 \xB7 time 0.60 (inform human review, not primary score)" },
      { ts: "08:15:00", by: "publish", event: "Published as CS-0412 \xB7 human review: REQUIRED" }
    ],
    updates: [
      ...
      { ts: "09:30", who: "K. Ngata (analyst)", what: "Confirmed portfolio match \xB7 no reclassification" }
    ],
  ...
  },
  {
    ...
    provenance: [
      ...
      { ts: "08:03:23", by: "enrichment", event: "No watchlist match \xB7 no portfolio keywords" },
  ...
  },
  {
    ...
    provenance: [
      { ts: "07:46:11", by: "parser", event: "Fetched Bills Digest bd2526a-048 (PDF \xB7 342kb)" },
      { ts: "07:46:45", by: "extractor", event: "Extracted sections: Purpose, Key provisions, Parliamentary consideration" },
      { ts: "07:47:02", by: "enrichment", event: "Linked to BILL-2026-048 \xB7 2 watchlists matched" },
      { ts: "07:47:10", by: "scoring", event: "Attention = 0.78 \u2192 HIGH \xB7 accreditation scope flagged as novel" },
  ...
  },
  {
    ...
    provenance: [
      ...
      { ts: "07:28:45", by: "enrichment", event: "Witness list extracted \xB7 OAIC flagged (regulator)" },
      { ts: "07:29:10", by: "scoring", event: "Attention = 0.82 \u2192 HIGH \xB7 time-sensitive (today)" },
  ...
  },
  {
    ...
    provenance: [
      ...
      { ts: "07:08:40", by: "enrichment", event: "Matched BILL-2026-041 \xB7 stage change: Listed for 2nd reading" },
      { ts: "07:09:20", by: "scoring", event: "Attention = 0.64 \u2192 MEDIUM \xB7 sitting day" },
  ...
  },
  {
    ...
    provenance: [
      ...
      { ts: "06:29:30", by: "scoring", event: "Attention = 0.52 \u2192 MEDIUM \xB7 contextual support" },
