...
function Sidebar({ page, onNavigate, mobileOpen }) {
  ...
  ))))), /* @__PURE__ */ React.createElement("div", { className: "side-status", "aria-label": "System status" }, /* @__PURE__ */ React.createElement("div", { className: "side-status-head" }, /* @__PURE__ */ React.createElement("span", { className: "dot", style: { background: "var(--ok)", boxShadow: "none" } }), /* @__PURE__ */ React.createElement("span", null, "Feeds configured")), /* @__PURE__ */ React.createElement("div", null, "Official RSS proxy configured; runtime health appears on Live"), /* @__PURE__ */ React.createElement("div", { className: "mono" }, "Status: local beta")), /* @__PURE__ */ React.createElement("div", { className: "side-foot" }, /* @__PURE__ */ React.createElement("div", { className: "avatar" }, "JV"), /* @__PURE__ */ React.createElement("div", { style: { lineHeight: 1.2 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12.5, fontWeight: 500 } }, "Juan Vega"), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "var(--mono)", fontSize: "var(--t-micro)", color: "var(--ink-4)" } }, "Prometheus Policy Lab \xB7 live beta"))));
}
