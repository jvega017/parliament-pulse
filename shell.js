...
function Topbar({ mobileNavOpen, setMobileNavOpen }) {
  ...
  const handleLiveRefresh = React.useCallback(() => {
    ...
    if (typeof refreshLiveState === "function") {
      Promise.resolve(refreshLiveState()).catch(() => {
        const msg = ageAtClick === "\u2014" ? "Live refresh failed - live data is unavailable" : `Live refresh failed - showing data from ${ageAtClick} ago`;
        toast(msg, "error");
      });
      return;
    }
  ...
  } }, /* @__PURE__ */ React.createElement(Icon, { name: "bell", size: 14 })), /* @__PURE__ */ React.createElement("button", { className: "btn primary sm", onClick: () => navigate("briefings") }, /* @__PURE__ */ React.createElement(Icon, { name: "plus", size: 13 }), " New brief"), /* @__PURE__ */ React.createElement(ShortcutHelp, null), /* @__PURE__ */ React.createElement("button", { className: "btn ghost sm", title: isDark ? "Switch to light mode" : "Switch to dark mode", "aria-label": isDark ? "Switch to light mode" : "Switch to dark mode", onClick: () => {
