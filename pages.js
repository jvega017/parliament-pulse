...
function PageSources() {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "page" }, /* @__PURE__ */ React.createElement("div", { className: "page-head" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "page-kicker" }, "Admin"), /* @__PURE__ */ React.createElement("h1", { className: "page-title" }, "Sources"), /* @__PURE__ */ React.createElement("div", { className: "page-sub" }, "Official APH feed register with live health checks from the Worker. Custom-feed validation remains a prototype workflow.")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 10 } }, /* @__PURE__ */ React.createElement("button", { className: "btn", title: "Re-polls the live RSS feeds if the Live page poller is mounted", onClick: () => {
    ...
    return /* @__PURE__ */ React.createElement("tr", { key: f.id, onClick: () => f.group !== "Custom" && openModal("feed", f.id) }, /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement("div", { style: { fontWeight: 500 } }, f.name), /* @__PURE__ */ React.createElement("div", { className: "mono", style: { fontSize: 10.5, color: "var(--ink-4)" } }, f.url.length > 56 ? f.url.slice(0, 56) + "\u2026" : f.url)), /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement("span", { className: "tag" }, f.group)), /* @__PURE__ */ React.createElement("td", { style: c && !c.ok ? { color: "var(--escalate)" } : void 0 }, c ? c.ok ? "Live" : `Error ${(_a = c.httpStatus) != null ? _a : ""}`.trim() : f.lastStatusCode != null ? f.lastStatusCode >= 200 && f.lastStatusCode < 300 ? "Live" : "Error" : "\u2014"), /* @__PURE__ */ React.createElement("td", { className: "mono", style: { fontSize: 11.5, color: "var(--ink-3)" } }, c ? fmtFetchedAt(c.checkedAt) : f.last || "\u2014"), /* @__PURE__ */ React.createElement("td", { className: "num" }, (_b = f.lastItemCount) != null ? _b : "\u2014"), /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement("span", { className: "tag" }, f.fpr)), /* @__PURE__ */ React.createElement("td", null, f.parser || "\u2014"));
  }), workerRows.map((c) => {
    var _a;
    return /* @__PURE__ */ React.createElement("tr", { key: c.url }, /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement("div", { style: { fontWeight: 500 } }, c.label), /* @__PURE__ */ React.createElement("div", { className: "mono", style: { fontSize: 10.5, color: "var(--ink-4)" } }, c.url.length > 56 ? c.url.slice(0, 56) + "\u2026" : c.url)), /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement("span", { className: "tag" }, c.group)), /* @__PURE__ */ React.createElement("td", { style: !c.ok ? { color: "var(--escalate)" } : void 0 }, c.ok ? "Live" : `Error ${(_a = c.httpStatus) != null ? _a : ""}`.trim()), /* @__PURE__ */ React.createElement("td", { className: "mono", style: { fontSize: 11.5, color: "var(--ink-3)" } }, fmtFetchedAt(c.checkedAt)), /* @__PURE__ */ React.createElement("td", { className: "num" }, "\u2014"), /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement("span", { className: "tag" }, "\u2014")), /* @__PURE__ */ React.createElement("td", null, "Worker-monitored"));
...
function LiveFeedStrip({ title, items, fetchedAt, emptyText }) {
  return /* @__PURE__ */ React.createElement("div", { className: "panel", style: { marginBottom: 16 } }, /* @__PURE__ */ React.createElement("div", { className: "panel-head" }, /* @__PURE__ */ React.createElement("h2", { className: "panel-title" }, title), /* @__PURE__ */ React.createElement(ProvenanceChip, { provenance: "live", title: "Live items from the Worker's composed /state feed" }), /* @__PURE__ */ React.createElement("span", { className: "panel-kicker", style: { marginLeft: "auto" } }, "fetched ", fmtFetchedAt(fetchedAt), " AEST")), /* @__PURE__ */ React.createElement("div", { className: "panel-body" }, items.length === 0 ? /* @__PURE__ */ React.createElement("div", { className: "empty" }, emptyText) : items.map((s, i) => /* @__PURE__ */ React.createElement("div", { key: s.id || i, className: "data-row", style: { display: "grid", gap: 6, padding: "10px 0", borderBottom: i < items.length - 1 ? "1px solid var(--line)" : 0 } }, /* @__PURE__ */ React.createElement("a", { href: s.link || "#", target: "_blank", rel: "noopener noreferrer", style: { display: "inline-flex", alignItems: "center", gap: 6, color: "var(--teal)", textDecoration: "none", fontSize: 13, fontWeight: 500 }, title: "Opens the source at aph.gov.au" }, s.title, " ", /* @__PURE__ */ React.createElement(Icon, { name: "ext", size: 11 })), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 10, alignItems: "center", flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement("span", { className: "mono t-label", style: { color: "var(--ink-4)", textTransform: "uppercase", letterSpacing: ".12em" } }, s.tags && s.tags[0] && s.tags[0].l || "item"), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11.5, color: "var(--ink-3)" } }, s.source), /* @__PURE__ */ React.createElement("span", { className: "mono", style: { fontSize: 10.5, color: "var(--ink-4)" } }, s.date))))));
}
...
function PageWatchlists() {
  ...
  ), /* @__PURE__ */ React.createElement("input", { "aria-label": "New watchlist name", placeholder: "New watchlist name", value: newName, onChange: (e) => setNewName(e.target.value), className: "search", style: { padding: "7px 10px" } }), /* @__PURE__ */ React.createElement("button", { className: "btn primary", onClick: () => {
    if (newName.trim()) {
