...
function LegalNoticePanel() {
  return /* @__PURE__ */ React.createElement("div", { className: "panel", style: { marginTop: "var(--gap-section)" } }, /* @__PURE__ */ React.createElement("div", { className: "panel-head" }, /* @__PURE__ */ React.createElement("h2", { className: "panel-title" }, "Privacy, terms and disclaimer"), /* @__PURE__ */ React.createElement("span", { className: "panel-kicker" }, "What this is, and what it does with your data")), /* @__PURE__ */ React.createElement("div", { className: "panel-body", style: { fontSize: 13, lineHeight: 1.65, color: "var(--ink-2)", maxWidth: 820 } }, /* @__PURE__ */ React.createElement("h3", { style: legalH }, "Independent, not affiliated"), /* @__PURE__ */ React.createElement("p", { style: legalP }, "Parliament Pulse is an independent project by Prometheus Policy Lab. It is not affiliated with, endorsed by, or an official product of the Parliament of Australia, the Department of Parliamentary Services, or any government body. It reads publicly available RSS feeds published at aph.gov.au and links every item back to its official source."), /* @__PURE__ */ React.createElement("h3", { style: legalH }, "Your privacy"), /* @__PURE__ */ React.createElement("p", { style: legalP }, "No account, login, or email is required or collected through this site. Preferences such as your reading streak and interface settings are stored only in your own browser and are never sent to us. We run no third-party analytics, advertising, or tracking. Live parliamentary data is polled from official feeds for display and is not stored on your device."), /* @__PURE__ */ React.createElement("h3", { style: legalH }, "Not advice"), /* @__PURE__ */ React.createElement("p", { style: legalP }, "Parliament Pulse is derived intelligence over public sources, provided for information only. It is not legal, parliamentary, or professional advice. Scoring, clustering and watchlist matching are the product's own analysis and can contain errors. Verify against the linked official source at aph.gov.au before relying on any item."), /* @__PURE__ */ React.createElement("h3", { style: legalH }, "Use and content"), /* @__PURE__ */ React.createElement("p", { style: legalP }, "The service is free and provided as-is, without warranty. Material published by the Australian Parliament remains subject to the Parliament's own copyright and terms of use; Parliament Pulse links to official sources rather than republishing them, and reproduces only brief factual descriptors with attribution. Coverage and content may change without notice."), /* @__PURE__ */ React.createElement("h3", { style: legalH }, "Contact and corrections"), /* @__PURE__ */ React.createElement("p", { style: legalP }, "To report a correction or ask a question, contact Prometheus Policy Lab."), /* @__PURE__ */ React.createElement("p", { className: "mono", style: { fontSize: 11, color: "var(--ink-4)", marginTop: 14 } }, "Last updated 23 July 2026.")));
}
function PageAbout() {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "page" }, /* @__PURE__ */ React.createElement("div", { className: "page-head" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "page-kicker" }, "Reference"), /* @__PURE__ */ React.createElement("h1", { className: "page-title" }, "About the data"), /* @__PURE__ */ React.createElement("div", { className: "page-sub" }, "What is live, what is representative, and what activates next. Every module below states its evidence basis and links to the page that carries it."))), /* @__PURE__ */ React.createElement("p", { style: { color: "var(--ink-2)", fontSize: 13.5, lineHeight: 1.6, maxWidth: 760, marginBottom: "var(--gap-section)" } }, "Parliament Pulse is a live beta. Six official APH RSS feeds poll on the Live page, and every live item links back to its source at aph.gov.au. Signal scoring, radar clustering, watchlist matching, QON pattern detection and the briefing queue are representative until the enrichment pipeline connects. This page is the honest account of that split: what you can already trust, and what still needs wiring."), /* @__PURE__ */ React.createElement(BetaReadinessPanel, { navigate: goto }), /* @__PURE__ */ React.createElement(CoverageActivationMatrix, { navigate: goto, copyPlan: copyActivationPlan }), /* @__PURE__ */ React.createElement(ProvenanceStackPanel, { navigate: goto }), /* @__PURE__ */ React.createElement(ProvenanceMetricsBand, { navigate: goto }), /* @__PURE__ */ React.createElement(LegalNoticePanel, null));
}
...
function recessEmptyText(chamber, feedNoun, url, linkLabel) {
  return /* @__PURE__ */ React.createElement(React.Fragment, null, chamber, " is not sitting. ", feedNoun, " resume when Parliament returns on ", NEXT_SITTING_DATE, ".", " ", /* @__PURE__ */ React.createElement("a", { href: url, target: "_blank", rel: "noopener noreferrer", style: { color: "var(--teal)" } }, linkLabel, " ", /* @__PURE__ */ React.createElement(Icon, { name: "ext", size: 11, style: { verticalAlign: "-1px" } })), ".");
}
function LiveSignalRow({ s, isLast }) {
  return /* @__PURE__ */ React.createElement("div", { className: "data-row", style: { padding: "10px 0", borderBottom: isLast ? 0 : "1px solid var(--line)" } }, s.link ? /* @__PURE__ */ React.createElement("a", { href: s.link, target: "_blank", rel: "noopener noreferrer", style: { color: "var(--teal)", textDecoration: "none", fontSize: 13, fontWeight: 500 }, title: "Opens the source at aph.gov.au" }, s.title, " ", /* @__PURE__ */ React.createElement(Icon, { name: "ext", size: 11 })) : /* @__PURE__ */ React.createElement("span", { style: { fontSize: 13, fontWeight: 500, color: "var(--ink-2)" } }, s.source), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 10, alignItems: "center", flexWrap: "wrap", marginTop: 4 } }, /* @__PURE__ */ React.createElement("span", { className: "mono t-label", style: { color: "var(--ink-4)", textTransform: "uppercase", letterSpacing: ".12em" } }, s.source), /* @__PURE__ */ React.createElement("span", { className: "mono", style: { fontSize: 11, color: "var(--ink-4)" } }, s.date)));
}
...
function DivisionsLiveList() {
  ...
  return /* @__PURE__ */ React.createElement(
    SittingDeskList,
    {
      rows,
      emptyIcon: "flag",
      unavailableText: /* @__PURE__ */ React.createElement(React.Fragment, null, "Parliament Pulse holds no verified division results right now because the live signal feed is unavailable. ", /* @__PURE__ */ React.createElement("a", { href: "https://www.aph.gov.au/Parliamentary_Business/Chamber_documents", target: "_blank", rel: "noopener noreferrer", style: { color: "var(--teal)" } }, "Open division results on aph.gov.au"), "."),
...
function TodaysHearingsPanel() {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "panel", style: { marginTop: 16 } }, /* @__PURE__ */ React.createElement("div", { className: "panel-head" }, /* @__PURE__ */ React.createElement("h2", { className: "panel-title" }, "Today's hearings"), /* @__PURE__ */ React.createElement("span", { className: "panel-kicker" }, "House, joint & Senate")), /* @__PURE__ */ React.createElement("div", { className: "panel-body" }, /* @__PURE__ */ React.createElement(
    SittingDeskList,
    {
      rows,
      emptyIcon: "clock",
      unavailableText: /* @__PURE__ */ React.createElement(React.Fragment, null, "Parliament Pulse holds no verified hearing schedule right now because the live signal feed is unavailable. ", /* @__PURE__ */ React.createElement("a", { href: "https://www.aph.gov.au/Parliamentary_Business/Committees", target: "_blank", rel: "noopener noreferrer", style: { color: "var(--teal)" } }, "Open committee hearings on aph.gov.au"), "."),
...
function PageCommittees() {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "page" }, /* @__PURE__ */ React.createElement("div", { className: "page-head" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "page-kicker" }, "Parliament"), /* @__PURE__ */ React.createElement("h1", { className: "page-title" }, "Committees"), /* @__PURE__ */ React.createElement("div", { className: "page-sub" }, "Live from the Worker's composed signal feed: Senate, House and joint committee reports, inquiries and hearings.")), /* @__PURE__ */ React.createElement("button", { className: "btn ghost", title: "Export the current live committee rows", onClick: exportPrepPack }, /* @__PURE__ */ React.createElement(Icon, { name: "brief", size: 13 }), " Export prep pack")), committeeLive && committeeLive.length > 0 && /* @__PURE__ */ React.createElement(
    LiveFeedStrip,
    {
      title: "Latest committee activity \xB7 live feed",
      items: committeeLive,
      fetchedAt: liveSignalsState.fetchedAt,
      emptyText: "No committee items in the current live window."
    }
  ), /* @__PURE__ */ React.createElement("div", { className: "grid g-3", style: { marginBottom: 18 } }, /* @__PURE__ */ React.createElement("div", { className: "panel stat" }, /* @__PURE__ */ React.createElement("div", { className: "stat-label" }, "Upcoming Senate hearings"), /* @__PURE__ */ React.createElement("div", { className: "stat-value" }, (upcomingHearings || []).length)), /* @__PURE__ */ React.createElement("div", { className: "panel stat" }, /* @__PURE__ */ React.createElement("div", { className: "stat-label" }, "Reports & inquiries \xB7 live"), /* @__PURE__ */ React.createElement("div", { className: "stat-value" }, (recentItems || []).length)), /* @__PURE__ */ React.createElement("div", { className: "panel stat" }, /* @__PURE__ */ React.createElement("div", { className: "stat-label" }, "Official committee feeds"), /* @__PURE__ */ React.createElement("div", { className: "stat-value" }, COMMITTEE_STRIP_LABELS.size, /* @__PURE__ */ React.createElement("span", { className: "unit" }, "tracked")))), /* @__PURE__ */ React.createElement(TodaysHearingsPanel, null), /* @__PURE__ */ React.createElement("div", { className: "grid g-2" }, /* @__PURE__ */ React.createElement("div", { className: "panel" }, /* @__PURE__ */ React.createElement("div", { className: "panel-head" }, /* @__PURE__ */ React.createElement("h2", { className: "panel-title" }, "Upcoming Senate hearings"), /* @__PURE__ */ React.createElement("span", { className: "panel-kicker" }, "Live feed")), /* @__PURE__ */ React.createElement("div", { className: "panel-body" }, /* @__PURE__ */ React.createElement(
    SittingDeskList,
    {
      rows: upcomingHearings,
      emptyIcon: "signal",
      unavailableText: /* @__PURE__ */ React.createElement(React.Fragment, null, "Parliament Pulse holds no verified upcoming Senate hearings right now because the live signal feed is unavailable. ", /* @__PURE__ */ React.createElement("a", { href: "https://www.aph.gov.au/Parliamentary_Business/Committees", target: "_blank", rel: "noopener noreferrer", style: { color: "var(--teal)" } }, "Open committee hearings on aph.gov.au"), "."),
      emptyKicker: "No verified upcoming hearings held",
      emptyBody: /* @__PURE__ */ React.createElement(React.Fragment, null, "Parliament Pulse holds no verified upcoming Senate hearings in the current live window. ", /* @__PURE__ */ React.createElement("a", { href: "https://www.aph.gov.au/Parliamentary_Business/Committees", target: "_blank", rel: "noopener noreferrer", style: { color: "var(--teal)" } }, "Open committee hearings on aph.gov.au"), ".")
    }
  ))), /* @__PURE__ */ React.createElement("div", { className: "panel" }, /* @__PURE__ */ React.createElement("div", { className: "panel-head" }, /* @__PURE__ */ React.createElement("h2", { className: "panel-title" }, "Recently tabled & opened"), /* @__PURE__ */ React.createElement("span", { className: "panel-kicker" }, "Live feed")), /* @__PURE__ */ React.createElement("div", { className: "panel-body" }, /* @__PURE__ */ React.createElement(
    SittingDeskList,
    {
      rows: recentItems,
      emptyIcon: "signal",
      unavailableText: /* @__PURE__ */ React.createElement(React.Fragment, null, "Parliament Pulse holds no verified committee reports or inquiries right now because the live signal feed is unavailable. ", /* @__PURE__ */ React.createElement("a", { href: "https://www.aph.gov.au/Parliamentary_Business/Committees", target: "_blank", rel: "noopener noreferrer", style: { color: "var(--teal)" } }, "Open committee reports on aph.gov.au"), "."),
      emptyKicker: "No verified reports or inquiries held",
      emptyBody: /* @__PURE__ */ React.createElement(React.Fragment, null, "Parliament Pulse holds no verified committee reports or inquiries in the current live window. ", /* @__PURE__ */ React.createElement("a", { href: "https://www.aph.gov.au/Parliamentary_Business/Committees", target: "_blank", rel: "noopener noreferrer", style: { color: "var(--teal)" } }, "Open committee reports on aph.gov.au"), ".")
    }
  )))));
}
function PageBills() {
  ...
  const exportBills = () => {
    ...
    const rows = (bills || []).map((b) => {
      var _a, _b;
      return [b.title, b.pub_date || "", (_a = b.attention) != null ? _a : "\u2014", (_b = b.confidence) != null ? _b : "\u2014", b.link || ""];
    });
    exportRowsCSV(headers, rows, `parliament-pulse-bills-${(/* @__PURE__ */ new Date()).toISOString().slice(0, 10)}.csv`);
  };
  return /* @__PURE__ */ React.createElement("div", { className: "page" }, /* @__PURE__ */ React.createElement("div", { className: "page-head" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "page-kicker" }, "Parliament \xB7 Bills Intelligence"), /* @__PURE__ */ React.createElement("h1", { className: "page-title" }, "Bills intelligence"), /* @__PURE__ */ React.createElement("div", { className: "page-sub" }, "Live from the Worker's /bills endpoint. Each title links to its official ParlInfo record; attention and confidence are Parliament Pulse's own scoring.")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 10, alignItems: "center" } }, bills && /* @__PURE__ */ React.createElement(ProvenanceChip, { provenance: "live", title: "Rows from the Worker's /bills endpoint" }), /* @__PURE__ */ React.createElement("button", { className: "btn", disabled: !bills || bills.length === 0, onClick: exportBills }, /* @__PURE__ */ React.createElement(Icon, { name: "download", size: 13 }), " Export register"))), /* @__PURE__ */ React.createElement("div", { className: "panel" }, /* @__PURE__ */ React.createElement("div", { className: "panel-head" }, /* @__PURE__ */ React.createElement("h2", { className: "panel-title" }, "Tracked bills"), /* @__PURE__ */ React.createElement("span", { className: "panel-kicker" }, bills ? `${bills.length} bill${bills.length !== 1 ? "s" : ""} \xB7 fetched ${fmtFetchedAt(live.fetchedAt)} AEST` : live.status === "loading" ? "Loading\u2026" : "\u2014")), live.status === "loading" && !bills ? /* @__PURE__ */ React.createElement(SkeletonTable, { rows: 6 }) : !bills ? /* @__PURE__ */ React.createElement("div", { className: "panel-body" }, /* @__PURE__ */ React.createElement(EmptyState, { icon: "bill", kicker: "Live data unavailable", variant: "error" }, "Parliament Pulse could not reach the Worker's /bills endpoint just now, so nothing renders rather than an invented bill list. ", /* @__PURE__ */ React.createElement("a", { href: "https://www.aph.gov.au/Parliamentary_Business/Bills_Legislation", target: "_blank", rel: "noopener noreferrer", style: { color: "var(--teal)" } }, "Open Bills Legislation on aph.gov.au"), ".")) : bills.length === 0 ? /* @__PURE__ */ React.createElement("div", { className: "panel-body" }, /* @__PURE__ */ React.createElement(EmptyState, { icon: "bill", kicker: "No bills returned" }, "The live /bills endpoint returned no rows just now. ", /* @__PURE__ */ React.createElement("a", { href: "https://www.aph.gov.au/Parliamentary_Business/Bills_Legislation", target: "_blank", rel: "noopener noreferrer", style: { color: "var(--teal)" } }, "Open Bills Legislation on aph.gov.au"), ".")) : /* @__PURE__ */ React.createElement("div", { className: "table-scroll" }, /* @__PURE__ */ React.createElement("table", { className: "ds" }, /* @__PURE__ */ React.createElement("thead", null, /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("th", null, "Title"), /* @__PURE__ */ React.createElement("th", null, "Published"), /* @__PURE__ */ React.createElement("th", null, "Attention"), /* @__PURE__ */ React.createElement("th", null, "Confidence"))), /* @__PURE__ */ React.createElement("tbody", null, bills.map((b) => {
    const link = safeHttpUrl(b.link);
    return /* @__PURE__ */ React.createElement("tr", { key: b.guid }, /* @__PURE__ */ React.createElement("td", { style: { fontWeight: 500 } }, link ? /* @__PURE__ */ React.createElement("a", { href: link, target: "_blank", rel: "noopener noreferrer", style: { color: "var(--teal)", textDecoration: "none" }, title: "Opens the source at aph.gov.au" }, b.title, " ", /* @__PURE__ */ React.createElement(Icon, { name: "ext", size: 11, style: { verticalAlign: "-1px" } })) : b.title, b.description && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "var(--ink-3)", marginTop: 2 } }, b.description)), /* @__PURE__ */ React.createElement("td", { className: "mono", style: { fontSize: 11.5, color: "var(--ink-3)" } }, fmtBillDate(b.pub_date)), /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement(Att, { level: b.attention })), /* @__PURE__ */ React.createElement("td", null, b.confidence != null ? /* @__PURE__ */ React.createElement(Conf, { n: b.confidence }) : /* @__PURE__ */ React.createElement("span", { className: "mono", style: { color: "var(--ink-4)" } }, "\u2014")));
  }))))), /* @__PURE__ */ React.createElement("div", { className: "panel", style: { marginTop: 16 } }, /* @__PURE__ */ React.createElement("div", { className: "panel-head" }, /* @__PURE__ */ React.createElement("h2", { className: "panel-title" }, "Related divisions"), /* @__PURE__ */ React.createElement("span", { className: "panel-kicker" }, "House")), /* @__PURE__ */ React.createElement("div", { className: "panel-body" }, /* @__PURE__ */ React.createElement(DivisionsLiveList, null))));
}
function PageParliament() {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "page" }, /* @__PURE__ */ React.createElement("div", { className: "page-head" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "page-kicker" }, "Parliament"), /* @__PURE__ */ React.createElement("h1", { className: "page-title" }, "Today in Parliament"), /* @__PURE__ */ React.createElement("div", { className: "page-sub" }, "Daily program, divisions, hearings and House news from official APH feeds."))), /* @__PURE__ */ React.createElement("div", { className: "grid g-overview" }, /* @__PURE__ */ React.createElement("div", { className: "panel" }, /* @__PURE__ */ React.createElement("div", { className: "panel-head" }, /* @__PURE__ */ React.createElement("h2", { className: "panel-title" }, "House \xB7 daily program")), /* @__PURE__ */ React.createElement("div", { className: "panel-body" }, /* @__PURE__ */ React.createElement(
    SittingDeskList,
    {
      rows: dailyProgramLive,
      emptyIcon: "clock",
      unavailableText: /* @__PURE__ */ React.createElement(React.Fragment, null, "Parliament Pulse holds no verified daily program right now because the live signal feed is unavailable. ", /* @__PURE__ */ React.createElement("a", { href: "https://www.aph.gov.au/Parliamentary_Business/Chamber_documents", target: "_blank", rel: "noopener noreferrer", style: { color: "var(--teal)" } }, "Open the House daily program on aph.gov.au"), "."),
  ...
  ))), /* @__PURE__ */ React.createElement("div", { className: "panel" }, /* @__PURE__ */ React.createElement("div", { className: "panel-head" }, /* @__PURE__ */ React.createElement("h2", { className: "panel-title" }, "Recent divisions"), /* @__PURE__ */ React.createElement("span", { className: "panel-kicker" }, "House")), /* @__PURE__ */ React.createElement("div", { className: "panel-body" }, /* @__PURE__ */ React.createElement(DivisionsLiveList, null)))), /* @__PURE__ */ React.createElement(TodaysHearingsPanel, null), /* @__PURE__ */ React.createElement("div", { className: "grid g-2", style: { marginTop: 16 } }, /* @__PURE__ */ React.createElement("div", { className: "panel" }, /* @__PURE__ */ React.createElement("div", { className: "panel-head" }, /* @__PURE__ */ React.createElement("h2", { className: "panel-title" }, "House news & media")), /* @__PURE__ */ React.createElement("div", { className: "panel-body" }, /* @__PURE__ */ React.createElement(
    SittingDeskList,
    {
      rows: newsLive,
      emptyIcon: "signal",
      unavailableText: /* @__PURE__ */ React.createElement(React.Fragment, null, "Parliament Pulse holds no verified House news right now because the live signal feed is unavailable. ", /* @__PURE__ */ React.createElement("a", { href: "https://www.aph.gov.au/house/rss/house_news", target: "_blank", rel: "noopener noreferrer", style: { color: "var(--teal)" } }, "Open House news on aph.gov.au"), "."),
      emptyKicker: "No verified items held",
      emptyBody: /* @__PURE__ */ React.createElement(React.Fragment, null, "Parliament Pulse holds no verified House news or media releases in the current live window. ", /* @__PURE__ */ React.createElement("a", { href: "https://www.aph.gov.au/house/rss/house_news", target: "_blank", rel: "noopener noreferrer", style: { color: "var(--teal)" } }, "Open House news on aph.gov.au"), ".")
    }
...
function renderMatchedAlertEvent(e, i) {
  ...
  return /* @__PURE__ */ React.createElement("div", { key: e.id || i, style: { padding: "8px 0", borderBottom: "1px solid var(--line)" } }, link ? /* @__PURE__ */ React.createElement("a", { href: link, target: "_blank", rel: "noopener noreferrer", style: { color: "var(--teal)", textDecoration: "none", fontWeight: 500, fontSize: 13 }, title: "Opens the source at aph.gov.au" }, title, " ", /* @__PURE__ */ React.createElement(Icon, { name: "ext", size: 11 })) : /* @__PURE__ */ React.createElement("span", { style: { fontWeight: 500, fontSize: 13 } }, title), when && /* @__PURE__ */ React.createElement("div", { className: "mono", style: { fontSize: 11, color: "var(--ink-4)", marginTop: 2 } }, fmtFetchedAt(when), " AEST"));
}
...
function PageWatchlists() {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "page" }, /* @__PURE__ */ React.createElement("div", { className: "page-head" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "page-kicker" }, "Workflow"), /* @__PURE__ */ React.createElement("h1", { className: "page-title" }, "Watchlists"), /* @__PURE__ */ React.createElement("div", { className: "page-sub" }, "The relevance engine. Click any watchlist for matches and configuration. Alert rules below run server-side, so matches land even when this tab is closed.")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, alignItems: "center" } }, /* @__PURE__ */ React.createElement(
    ProvenanceChip,
    {
