...
function PageSources() {
  ...
  )), health.status === "error" && !health.items && /* @__PURE__ */ React.createElement("div", { className: "panel-body" }, /* @__PURE__ */ React.createElement(EmptyState, { icon: "rss", kicker: "Feed status unavailable", variant: "error" }, "The status service did not respond. Direct links to each official APH feed remain available below.")), /* @__PURE__ */ React.createElement("div", { className: "table-scroll" }, /* @__PURE__ */ React.createElement("table", { className: "ds" }, /* @__PURE__ */ React.createElement("thead", null, /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("th", null, "Source"), /* @__PURE__ */ React.createElement("th", null, "Group"), /* @__PURE__ */ React.createElement("th", null, "Status"), /* @__PURE__ */ React.createElement("th", null, "Last"), /* @__PURE__ */ React.createElement("th", { className: "num" }, "Today"), /* @__PURE__ */ React.createElement("th", null, "FPR"), /* @__PURE__ */ React.createElement("th", null, "Parser"))), /* @__PURE__ */ React.createElement("tbody", null, allFeeds.map((f) => {
    var _a, _b;
    const c = checkByUrl.get(f.url);
    return /* @__PURE__ */ React.createElement("tr", { key: f.id, onClick: () => f.group !== "Custom" && openModal("feed", f.id) }, /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement("div", { style: { fontWeight: 500 } }, f.name), /* @__PURE__ */ React.createElement("div", { className: "mono", style: { fontSize: "var(--t-micro)", color: "var(--ink-4)" } }, f.url.length > 56 ? f.url.slice(0, 56) + "\u2026" : f.url)), /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement("span", { className: "tag" }, f.group)), /* @__PURE__ */ React.createElement("td", { style: c && !c.ok ? { color: "var(--escalate)" } : void 0 }, c ? c.ok ? "Live" : `Error ${(_a = c.httpStatus) != null ? _a : ""}`.trim() : f.lastStatusCode != null ? f.lastStatusCode >= 200 && f.lastStatusCode < 300 ? "Live" : "Error" : "\u2014"), /* @__PURE__ */ React.createElement("td", { className: "mono", style: { fontSize: 11.5, color: "var(--ink-3)" } }, c ? fmtFetchedAt(c.checkedAt) : f.last || "\u2014"), /* @__PURE__ */ React.createElement("td", { className: "num" }, (_b = f.lastItemCount) != null ? _b : "\u2014"), /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement("span", { className: "tag" }, f.fpr)), /* @__PURE__ */ React.createElement("td", null, f.parser || "\u2014"));
  }), workerRows.map((c) => {
    var _a;
...
function PageParliament() {
  const { openModal, toast } = useStore();
  const live = useLiveState("signals");
  const chamberFeedLabels = /* @__PURE__ */ new Set(["House Divisions", "House Daily Program", "House Media Releases"]);
  const chamberLive = live.items ? live.items.filter((s) => chamberFeedLabels.has(s.source)) : null;
  return /* @__PURE__ */ React.createElement("div", { className: "page" }, /* @__PURE__ */ React.createElement("div", { className: "page-head" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "page-kicker" }, "Parliament"), /* @__PURE__ */ React.createElement("h1", { className: "page-title" }, "Today in Parliament"), /* @__PURE__ */ React.createElement("div", { className: "page-sub" }, "Daily program, divisions, and chamber-relevant items from official APH feeds."))), chamberLive && /* @__PURE__ */ React.createElement(
    LiveFeedStrip,
    {
      title: "Latest chamber items \xB7 live feed",
      items: chamberLive,
      fetchedAt: live.fetchedAt,
      emptyText: "No chamber items in the current live window."
    }
  ), /* @__PURE__ */ React.createElement("div", { className: "grid g-overview" }, /* @__PURE__ */ React.createElement("div", { className: "panel" }, /* @__PURE__ */ React.createElement("div", { className: "panel-head" }, /* @__PURE__ */ React.createElement("h2", { className: "panel-title" }, "House \xB7 daily program"), /* @__PURE__ */ React.createElement("span", { className: "panel-kicker" }, "24 Apr 2026"), /* @__PURE__ */ React.createElement("span", { className: "chip-fixture", style: { marginLeft: "auto" } }, "Representative data")), /* @__PURE__ */ React.createElement("div", { className: "panel-body" }, /* @__PURE__ */ React.createElement("div", { className: "timeline" }, [
...
Recommended action: monitor for Estimates references and verify against Hansard or QON source material.`, toast, "Estimates monitor note copied") }, /* @__PURE__ */ React.createElement(Icon, { name: "brief", size: 13 }), " Draft Estimates monitor note"), /* @__PURE__ */ React.createElement("button", { className: "btn", title: "Mark this cluster as tracked in this session", onClick: () => {
  ...
  } }, "Mark as coincidence")), /* @__PURE__ */ React.createElement("div", { className: "mono", style: { fontSize: "var(--t-micro)", color: "var(--ink-3)", marginTop: 8, letterSpacing: ".08em" } }, "Session status: ", clusterStatus)), /* @__PURE__ */ React.createElement("div", { className: "panel", style: { marginTop: 16 } }, /* @__PURE__ */ React.createElement("div", { className: "panel-head" }, /* @__PURE__ */ React.createElement("h2", { className: "panel-title" }, "How patterns are detected"), /* @__PURE__ */ React.createElement("span", { className: "panel-kicker" }, "Indicator logic")), /* @__PURE__ */ React.createElement("div", { className: "panel-body" }, /* @__PURE__ */ React.createElement("div", { className: "grid g-2" }, [
...
function PageBriefings() {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "page" }, /* @__PURE__ */ React.createElement("div", { className: "page-head" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "page-kicker" }, "Workflow"), /* @__PURE__ */ React.createElement("h1", { className: "page-title" }, "Briefings"), /* @__PURE__ */ React.createElement("div", { className: "page-sub" }, "Generated local briefs appear above. Representative queue examples below show the intended review workflow: What happened \xB7 Source \xB7 Why it matters \xB7 Recommended action \xB7 Evidence \xB7 Uncertainty \xB7 Human review.")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, flexWrap: "wrap", justifyContent: "flex-end" } }, /* @__PURE__ */ React.createElement("button", { className: "btn", onClick: () => downloadBriefingQueue(briefs, toast) }, /* @__PURE__ */ React.createElement(Icon, { name: "download", size: 13 }), " Export queue"), /* @__PURE__ */ React.createElement("button", { className: "btn primary", title: "Open signals to generate a brief", onClick: () => {
    ...
    navigate("signals");
  } }, /* @__PURE__ */ React.createElement(Icon, { name: "plus", size: 13 }), " New brief"))), /* @__PURE__ */ React.createElement("div", { className: "grid g-briefings", style: { gap: 16 } }, /* @__PURE__ */ React.createElement("div", { className: "panel" }, /* @__PURE__ */ React.createElement("div", { className: "panel-head" }, /* @__PURE__ */ React.createElement("h2", { className: "panel-title" }, "Queue"), /* @__PURE__ */ React.createElement("span", { className: "panel-kicker" }, briefs.length, " pending")), /* @__PURE__ */ React.createElement("div", null, briefs.length === 0 ? /* @__PURE__ */ React.createElement(EmptyState, { icon: "brief", kicker: "No briefs yet" }, "Open any signal and choose Generate brief. Your briefs appear here with their evidence links.") : briefs.map((b, i) => {
    const id = briefId(b);
...
function PageWatchlists() {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "page" }, /* @__PURE__ */ React.createElement("div", { className: "page-head" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "page-kicker" }, "Workflow"), /* @__PURE__ */ React.createElement("h1", { className: "page-title" }, "Watchlists"), /* @__PURE__ */ React.createElement("div", { className: "page-sub" }, "The relevance engine. Click any watchlist for matches and configuration.")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, alignItems: "center" } }, /* @__PURE__ */ React.createElement(
    ...
    }, style: (selectedWl == null ? void 0 : selectedWl.name) === w.name ? { borderColor: "var(--brass)" } : {} }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8 } }, /* @__PURE__ */ React.createElement("span", { className: "wl-name" }, w.name), /* @__PURE__ */ React.createElement("span", { className: "mono", style: { fontSize: "var(--t-micro)", color: "var(--brass)", background: "var(--panel-hi)", border: "1px solid var(--brass-soft)", padding: "1px 6px", borderRadius: 4, marginLeft: "auto" } }, matchCount, " matches")), /* @__PURE__ */ React.createElement("div", { className: "wl-meta" }, /* @__PURE__ */ React.createElement("span", null, w.keywords, " keywords"), /* @__PURE__ */ React.createElement("span", null, "\xB7"), /* @__PURE__ */ React.createElement("span", null, "7-day")), derived ? /* @__PURE__ */ React.createElement("div", { className: "mono", style: { marginTop: 6, color: "var(--ink-4)", fontSize: 11 } }, "\u2014 no trend history") : /* @__PURE__ */ React.createElement("div", { className: "spark", style: { marginTop: 2 } }, trend.map((v, i) => /* @__PURE__ */ React.createElement("span", { key: i, style: { height: v / max * 20 + 2 + "px" } }))));
...
function PageSignals() {
  ...
  ))), visible.length === 0 ? filter !== "all" ? /* @__PURE__ */ React.createElement(
    EmptyState,
    {
      icon: "signal",
      kicker: "No matches",
